    ...
    <div className="w-full flex flex-wrap h-screen">
      ...
      <div className="w-1/2 shadow-2xl hidden xl:block">
        <img
          ...
          src="https://images.pexels.com/photos/733854/pexels-photo-733854.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          alt="Login Visual"
        />
      </div>

      <div className="w-full xl:w-1/2 flex flex-col">
        <div className="flex justify-center xl:justify-start pt-12 xl:pl-12 xl:-mb-24">
